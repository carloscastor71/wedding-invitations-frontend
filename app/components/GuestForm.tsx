        ...
        <div className="p-6">
          ...
          <div className="mb-8">
            ...
            >
              <p className="text-lg leading-relaxed">
                Por favor proporciona los nombres de las personas que asistirán
                a la recepción. Puedes llenar solo los espacios que necesites.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            ...
            >
              ...
              {submitting
                ? "Guardando..."
                : `Confirmar ${filledGuests} Invitado${
                    filledGuests !== 1 ? "s" : ""
                  }`}
            </button>
          </div>
